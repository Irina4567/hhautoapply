...
DEFAULT_TEMPLATE = (
    ...
    "Имею коммерческий опыт PHP/Bitrix-разработчика 4+ года: "
    "1С-Битрикс D7, Bitrix24, Laravel, проектирование REST API "
    "и интеграций, оптимизация SQL и производительности, менторинг команды. "
