    ...
    async def _fill_response_form(self, page: Page, cover_letter: str, vacancy_url: str):
                ...
                for grp_name, grp in radio_groups.items():
                    ...
                    if chosen_idx is None and len(options) > 1:
                        ...
                        ai_system = (
                            ...
                            "Профиль кандидата:\n"
                            "- Проживает в Туле\n"
                            "- Готова работать удалённо\n"
                            "- НЕ готова к переезду\n"
                            "- К редким командировкам готова\n"
                            "- Желаемая зарплата от 200 тыс. рублей на руки, готова обсуждать\n"
                            "- Уровень: middle PHP-разработчик, 4+ года в IT\n"
                            "- Английский — рабочий уровень (опыт с иностранной командой)\n"
                            "- Опыт с PHP 8, Laravel, 1С-Битрикс D7, Bitrix24, MySQL/PostgreSQL,\n"
                            "  REST API, интеграциями (платёжные системы, маркетплейсы), e-commerce\n\n"
        ...
        if question_pairs:
            ...
            user_msg = (
                ...
                "  - Зарплата → от 200 000 руб на руки, готова обсуждать\n"
                "  - Местоположение / РФ → Тула, проживаю в РФ, готова к удалённой работе\n"
                "  - Переезд → НЕ готова к переезду\n"
                "  - Командировки → готова к редким командировкам\n"
                "  - Английский → рабочий уровень, есть опыт работы с иностранной командой (621Inc, Канада)\n"
                "  - Уровень → Middle PHP-разработчик, в IT 4+ года\n"
                "  - Текущее место → Медиакейк, PHP-разработчик, с сентября 2023\n"
                ...
                "  - Стек → PHP 8, Laravel, 1С-Битрикс D7 (ORM, компоненты, модули), Bitrix24 (CRM, бизнес-процессы)\n"
                "  - Опыт REST API → проектирование и разработка REST API для фронтенда и внешних интеграций, рефакторинг legacy API\n"
                "  - Опыт с платёжными системами → да, 7 интеграций (Сбербанк, Тинькофф, Альфа-Банк и др.), маркетплейсы, аналитика\n"
                "  - Опыт с 1С-Битрикс → основной стек: разработка и оптимизация компонентов/модулей на D7 с ORM\n"
                "  - Опыт с Bitrix24 → кастомизация и поддержка CRM, создание модулей, бизнес-процессы\n"
                "  - SQL → сложные запросы, оптимизация схемы данных и индексов; MySQL, PostgreSQL\n"
                "  - Frontend → JavaScript (ES6+), jQuery, HTML5, CSS3, чтение/правки Nuxt.js\n"
                "  - DevOps → Git, GitFlow, CI/CD (базовый), настройка окружения, деплой на production\n"
                "  - Производительность → ускорение TTFB в 3-4 раза через оптимизацию кэширования и SQL\n"
                "  - Управление командой → техническое руководство, code review, менторинг junior-разработчиков\n\n"
